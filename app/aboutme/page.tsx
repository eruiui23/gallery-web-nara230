    ...
    <div className=" flex flex-col justify-center h-screen items-center">
      <div className="w-125 px-10">
        <Image
          ...
          sizes="33vw"
        />
        <h1 className="text-3xl text-center mt-15 font-bold text-nowrap">about me nya belom jadi ...</h1>
        <p className="text-center mt-5">btw kalo mau takedown foto dm ig @reynr aja y :D</p>
      </div>
    </div>
  );
}
